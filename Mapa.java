...
public class Mapa{
	...
	*/
		...
		camaras[0][2]=new Camara(random.nextInt(4), 1, random.nextInt(5), random.nextInt(3), 0, 2, 0, 0, 2, "Las raíces no se ven, y es mas alta que un árbol. Arriba y arrriba sube; y sin embargo no crece.", "montaña", 3);
		camaras[1][2]=new Camara(random.nextInt(4), 1, random.nextInt(5), random.nextInt(3), 0, 2, 1, 2, 0, "¿Qué es algo y nada a la vez?", "pez", 4);
		...
		camaras[1][3]=new Camara(random.nextInt(4), 2, random.nextInt(5), random.nextInt(3), 0, 2, 0, 2, 0, "Es tuyo pero todos lo usan mas que tú.", "nombre", 7);
		...
		camaras[0][4]=new Camara(random.nextInt(4), 2, random.nextInt(5), random.nextInt(3), 0, 2, 0, 0, 2, "Tengo agujas y no sé coser, tengo números y no sé contar.", "reloj", 9);
		camaras[1][4]=new Camara(random.nextInt(4), 2, random.nextInt(5), random.nextInt(3), 0, 0, 0, 2, 2, "Sin ser árbol tengo hojas, sin ser bestia un buen lomo, y mi nombre en cada lomo esta.", "libro", 10);
		...
		camaras[2][3]=new Camara(random.nextInt(4), 3, random.nextInt(5), random.nextInt(3), 0, 2, 2, 0, 0, "Viste de un chaleco blanco y tambien negro de frac es algo que no vuela, pero sabe nadar.", "pingüino", 13);
		...
		camaras[2][0]=new Camara(random.nextInt(4), 4, random.nextInt(5), random.nextInt(3), 0, 0, 2, 0, 2, "Va a través de ciudades y sobre colinas pero nunca se mueve.", "carretera", 16);
		camaras[3][0]=new Camara(random.nextInt(4), 4, random.nextInt(5), random.nextInt(3), 0, 0, 0, 2, 2, "No ha sido, pero va a ser y cuando sea ya no lo será.", "mañana", 17);
		camaras[4][0]=new Camara(random.nextInt(4), 4, random.nextInt(5), random.nextInt(3), 0, 0, 2, 2, 0, "¿Qué es lo que quitas y crece?", "hoyo", 18);
		camaras[4][1]=new Camara(random.nextInt(4), 4, random.nextInt(5), random.nextInt(3), 0, 2, 2, 1, 0, "Si me conoces me querrás compartir, pero si me compartes desapareceré.", "secreto", 19);
		camaras[4][2]=new Camara(random.nextInt(4), 4, random.nextInt(5), random.nextInt(3), 21, 2, 0, 0, 0, "¿Qué es lo que se sostiene y no se rompe?", "promesa", 20);
		...
		camaras[4][3]=new Camara(random.nextInt(4), 5, random.nextInt(5), random.nextInt(3), 0, 0, 2, 2, 0, "¿Cuál es la estrella que no brilla?", "estrella de mar", 24);
